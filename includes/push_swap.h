...
int					ft_quick_sort(t_stacks *stacks, t_pile **sorted,\
		char **operations);
int					sort_inf_subsize(t_stacks *stacks, t_pile *sublst,\
		int sub_size);
...
int					push_nbr(t_stacks *stacks, char **operations, int index,\
		int nbr);
